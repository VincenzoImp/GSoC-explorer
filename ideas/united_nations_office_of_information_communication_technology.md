...
**Scraped:** 2026-02-20T12:04:33.338299

---

☀️ 🇺🇳

![UN OICT Logo](img/oict-logo.png "United Nations Office of Information and Communications Technology")

## On This Page

- [About UN's OICT](#about-uns-oict)
- [Key Information for Applicants](#key-information-for-applicants)
- [Choosing the Best GSoC Project for You](#choosing-the-best-gsoc-project-for-you)
- [2026 Project Ideas & Source Code](#2026-project-ideas--source-code)
  - [FireForm: An Open Source “Report Once, File Everywhere” System for First Responders](#fireform-an-open-source-report-once-file-everywhere-system-for-first-responders)
  - [OG–CLEWS: Integrating Open-Source Economic and Environmental Models for Sustainable Development](#ogclews-integrating-open-source-economic-and-environmental-models-for-sustainable-development)
...
_Note that UN-OICT is an "umbrella organization" which means that our team is actually a group of projects that work together to do Google Summer of Code. If you're going to apply with us, you'll need to choose from one of those teams, because that defines which mentors will be helping you with your applications. Contributor applications without any identified sub-org and mentor to evaluate them will be rejected. You can communicate with and even make early contributions to more than one sub-org while you figure out which project you’d like to apply to._
...
- Source Code: https://github.com/juanalvv/rte2025
- [Additional Project Information](https://idea.unite.un.org/servlet/hype/IMT?documentTableId=1639627035372729781&userAction=Browse&templateName=&documentId=8cad7c1d6f4de57a0bf944263319d4a9)
...
- **Mr. Vincent Harkins** (​​vharkins@ucsc.edu)
- **Mr. Marc Verges** (mvergess@ucsc.edu)
- **Mr. Omar Mohsine** (mohsine@un.org)
...
- Source Code: https://github.com/OSeMOSYS/MUIO/
...
- **Mr. Marcelo LaFleur** is a Senior Economist at the Economic Analysis and Policy Division (EAPD) of the United Nations Department of Economic and Social Affairs (UN DESA) who serves as a core maintainer of open-source OG-Core model repositories (e.g., the OG-PHL repository on GitHub) and contributes to public training materials for the OG-Core framework. (lafleurm@un.org)
- **Mr. Alfonso Acosta Gonçalves** is a Senior Adviser in Integrated Modelling for Sustainable Development at EAPD in UN DESA, lead for the OG–CLEWS modelling project. (acostagoncalves@un.org)
